...
// function PostCard({ user_id, image, date_posted, like_count, id, content, avatar_url, username, liked }) {
...
//                 <Link to={`/profile/${user_id}`} ><img src={postInfo[1]} alt="User Profile" className="user-profile-photo" /></Link>
//                 <Link to={`/profile/${user_id}`} style={{ textDecoration: 'none', color: 'inherit' }}><h2 className="user-name">{postId[2]}</h2></Link>
//             </div>
//             <img src={postInfo.[2]} alt="Post" className="post-image" />
