    ...
    return (
        ...
        <div div className="s-cont" >
            <div class="sinput-container">
                ...
                />
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="sicon">
            ...
            {filteredUsers.length > 0 ? <SearchResult filteredUsers={filteredUsers} handleClick={handleClick} /> : ''}
        </div>
    )
}
